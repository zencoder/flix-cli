 ...
 *
 */
public class TemporalResamplingVideoCodecModifer implements CodecModifier {
    LogWrapper log = LogWrapper.getInstance();
    
    public TemporalResamplingVideoCodecModifer() {
	super();
    }
	...
	return "Temporal Resampling codec modifier.";
    }
	...
	return OptionBuilder.withArgName("value")
	    		    .hasArg()
	    		    .withDescription("Sets the Temporal Resampling option for codecs which support it -- currently VP6.")
	    		    .create(getSwitch());
    }

    public String getSwitch() {
	return "vtemporalresample";
    }
