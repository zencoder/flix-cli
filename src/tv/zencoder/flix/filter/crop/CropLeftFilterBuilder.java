...
public class CropLeftFilterBuilder extends FilterBuilderBase {

    public CropLeftFilterBuilder() {
	super();
    }
	...
	return OptionBuilder.withArgName("size")
                            .hasArg()
                            .withDescription("Isolates the left of a frame to crop within the input video.")
                            .create(getSwitch());
    }
